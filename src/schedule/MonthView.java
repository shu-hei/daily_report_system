...
/**
 * Servlet implementation class CalendarIndex2
 */
...
public class MonthView extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        /* 年月のリンク作成 */
        sb.append(createMonthLink(year, month, request));
        ...
        for (int i = 0 ; i < weekCount ; i++){
            ...
            sb.append(createScheduleStr(year, month, i * 7, calendarDay, request));
        }
    ...
    /* スケジュール登録へのリンクを設定する */
    protected String createScheduleStr(int year, int month, int startDayNo, int[] calendarDay, HttpServletRequest request){
        StringBuffer sb = new StringBuffer();
        ...
        for (int i = startDayNo ; i < startDayNo + 7 ; i++){
            if (calendarDay[i] > 35){
                ...
                sb.append("<a href=\""+request.getContextPath()+"/CalendarNew");
                ...
                sb.append("\">");
                sb.append("<img src=\"./img/icon.png\" width=\"14\" height=\"16\">");
                sb.append("</a>");
                sb.append("</td>");
            }
            sb.append("</td>");
    ...
    protected String createMonthLink(int year, int month, HttpServletRequest request){
        StringBuffer sb = new StringBuffer();

        sb.append("<p>");

        sb.append("<a href=\""+request.getContextPath()+"/MonthView?YEAR=");
        sb.append(year);
        sb.append("&MONTH=");
        sb.append(month - 1);
